...
def preprocess_image(img_pil):
    """Phase 1+2+3: Grayscale → Adaptive Threshold → Background Line Removal.
    Delegates to preprocessor.full_preprocess() so both pipeline and visualizer
    share exactly the same preprocessing logic.
    """
