...
def clean_single_crop_with_masks(img_path):
    ...
    for label in range(1, num_labels):
        ...
        # Adjust thresholds for crop size
    ...
    cv2.imwrite(os.path.join(out_dir, "test_crop_orig.png"), img_bgr)
    cv2.imwrite(os.path.join(out_dir, "test_crop_cleaned.png"), cv2.cvtColor(np.array(cleaned), cv2.COLOR_RGB2BGR))
    cv2.imwrite(os.path.join(out_dir, "test_crop_review.png"), cv2.cvtColor(review, cv2.COLOR_RGB2BGR))
    print("Saved outputs to scratch.")

clean_single_crop_with_masks(r"d:\Internship\OCR_PDF\sign-detection-yolo8n\Nived-dataset\dataset\dataset\crop_img\msil_crop_129.jpg")
clean_single_crop_with_masks(r"d:\Internship\OCR_PDF\sign-detection-yolo8n\Nived-dataset\dataset\dataset\crop_img\intra_crop_15.jpg")
